...
public final class Geode
{
    ...
    static
    {
        try
        {
            ...
            Class.forName("com.geode.net.info.ClientInfosBuilder");
            Class.forName("com.geode.net.info.ServerInfosBuilder");
            Class.forName("com.geode.net.info.TLSInfosBuilder");
