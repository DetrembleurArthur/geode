...
import com.geode.net.net.builders.ClientInfosBuilder;
import com.geode.net.net.builders.MqttInfosBuilder;
import com.geode.net.net.builders.ServerInfosBuilder;
import com.geode.net.net.builders.SettingsInfosBuilder;
import com.geode.net.net.builders.UdpInfosBuilder;
import com.geode.net.net.loaders.Loader;
import com.geode.net.net.logging.Logger;
import com.geode.net.net.channels.ChannelsManager;
import com.geode.net.net.mqtt.MqttInfos;
import com.geode.net.net.mqtt.MqttInstance;
...
public final class Geode
{
    ...
    static
    {
        try
        {
            Class.forName("com.geode.net.net.builders.ChannelsManagerInfosBuilder");
            Class.forName("com.geode.net.net.builders.ClientInfosBuilder");
            Class.forName("com.geode.net.net.builders.ServerInfosBuilder");
            Class.forName("com.geode.net.net.builders.TLSInfosBuilder");
            Class.forName("com.geode.net.net.builders.UdpInfosBuilder");
            Class.forName("com.geode.net.net.builders.MqttInfosBuilder");
            Class.forName("com.geode.net.net.builders.SettingsInfosBuilder");
        }
